...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Prepare registration data (username will be auto-generated from email)
      ...
      <div className="bg-white rounded-2xl shadow-editorial p-8 border border-outline-variant/20">
        ...
        <div className="mb-6">
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 bg-white border border-outline-variant rounded-xl px-4 py-3 text-sm font-semibold text-on-surface hover:bg-surface-container-low transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
